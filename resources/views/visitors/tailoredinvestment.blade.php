...
<div class="main-content">
    ...
    <section class="breadcrumb-section" style="background-image: url('assets/images/teann.jpg')">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <!-- breadcrumb Section Start -->
            <div class="breadcrumb-content">
               <h5>Tailored Investment Approach</h5>
            </div>
...
Much like a tailor who alters the hem, sleeves, and collar of a suit to fit an individual's proportions, we take a variety of factors into account to create a portfolio tailored to your needs and any of your emergencies.
                ...
                <div class="col-md-4">
                    ...
                    <img class="card-img-top" src="assets/images/timg1.jpg" alt="financialplanning">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <h3>A Top-Down Investment Approach</h3>
                    <div><p>
...
However, we prefer a top-down investing approach. This method emphasizes broader economic factors. The strategy determines the allocation and selection of assets based on macroeconomic characteristics and how they expect to affect different areas of the market. Once the investors have identified the areas they think will perform well, they can select individual securities within those areas.
                ...
                <div class="col-md-12">  <br>
                    ...
                    <h3>Top-Down vs. Bottom-Up Investment Approaches</h3>
                    <div><p>
In a bottom-up portfolio, the shape and direction of the total portfolio are a result of the assets that comprise it. The total portfolio’s main focus will generally be around the performance of the individual securities and how each of them performs in the short term.</p>
<p>
A bottom-up portfolio may be limited to the investor’s knowledge of individual securities and may lack a coherent strategy as the primary focus is stock selection. In other words, rather than looking for the needle in the haystack, it might be better off looking for the haystack with the most needles.</p>
<p>
Alternatively, a top-down portfolio is where broader economic analysis and forecast drive tactical decisions. A top-down portfolio considers the wider economic and macroeconomic context before moving to security selection. If the economic forecast is for a healthy economy, you should likely invest. Your analysis and forecast should then guide which security characteristics such as sector, style, and country should be targeted.</p>
<p>
Many investors and industry professionals still tend to take a bottom-up approach to invest despite its potential limitations.
                ...
                <h3>Why We Prefer a Top-Down Approach to Investing</h3>
                    <div><p>
We believe the majority of your investment returns are a result of asset allocation to your portfolio’s mix of stocks, bonds, cash, and other securities. Therefore, asset allocation likely plays a more significant role in your long-term portfolio returns than individual securities.
For example, compare an all-cash portfolio with an all-stock portfolio. Over time, you would see a much bigger difference between the all-cash and all-stock portfolios compared with two all-stock portfolios holding different stocks. The type of assets you hold plays a major role in determining the kinds of returns you receive over longer periods of time. Because of this, we believe you should first consider selecting the right asset class to invest in before analyzing individual securities.
</p>
<p>
When investing in cryptocurrency or stocks, you should consider the overall market environment and decide where to invest based on the outlook for each country, sector, or company size and how they have performed at similar points in earlier market cycles. For example, if you find that late in bull (upward trending) market, mega-cap stocks have historically performed better, you may want to emphasize these stocks in your portfolio. Such a task requires a fixation on detail that introduces an inherent bias into the research process, which could divert your attention away from your longer-term investment goals.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h3>Our Top-Down Approach to Investing: 70/20/10
</h3>
<p>
    
We believe 70% of investment returns are attributable to a portfolio’s asset allocation, 20% to category decisions—what we call sub-asset allocation—and 10% to the selection of individual securities.<br>

Exhibit 1: {{$compd? $compd->companyname :"company name"}}’s 70/20/10 Investment Approach
</p>
...
<div class="row">
    ...
    <div class="col-md-8 col-md-offset-3">
                    ...
                    <img class="card-img-top" src="assets/images/portmgtimg.png" alt="tailoredplanning">
...
Putting It Together: A Top-Down Approach on Two Main Levels
        ...
        <strong> Think Strategically: Select Assets to Match Your Goals</strong>
...
Since every investor is different, there is no magic formula for the right mix of assets. It depends on your unique set of financial goals, needs, and risk tolerance. If you have significant growth needs, you may be better off investing in assets that have historically provided higher returns along with higher short-term volatility, like stocks. If you require less growth and need more cash flow, you may be better off increasing your portfolio’s allocation towards assets that have historically provided lower long-term returns and lower short-term volatility, like bonds.
         ...
         <p>
             Think Tactically: Use Market Forecasts to Adjust Your Asset Selection<br>
