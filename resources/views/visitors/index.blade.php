                            ...
                            <div class="row h-100">
                                <div
                                    ...
                                    <p
                                        ...
                                        Highly skilled industrial expertise assisting you in meeting your financial
                                        objectives.</p>
                    ...
                    <div class="card card-body">
                        ...
                        <div style="padding: 0;margin: 0;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <defs>
                                    <rect id="prefix__a" width="290" height="180" x="0" y="0"
                                        rx="10"></rect>
                                    <rect id="prefix__c" width="86" height="86" x="0" y="0"
                                        rx="4"></rect>
                                    <rect id="prefix__i" width="305" height="180" x="12" y="31"
                                        rx="7"></rect>
                                    <rect id="prefix__n" width="48" height="48" x="0" y="0"
                                        rx="4"></rect>
                                    <linearGradient id="prefix__j" x1="50%" x2="50%" y1="0%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#FFF" stop-opacity=".75"></stop>
                                        <stop offset="100%" stop-color="#2C2C2C" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__k" x1="50%" x2="50%" y1="38.65%"
                                        y2="89.71%">
                                        <stop offset="0%" stop-color="#F6FCEE"></stop>
                                        <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__l" x1="50%" x2="50%" y1="0%"
                                        y2="100%">
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <g transform="translate(9 119)">
                                            ...
                                            <g fill-rule="nonzero">
                                                <use fill="#000" filter="url(#prefix_d)" xlink:href="#prefix_c"></use>
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <g transform="translate(59 13)">
                                            <g opacity=".75">
                                                <use fill="#000" filter="url(#prefix_h)" xlink:href="#prefix_i"></use>
                                                <use fill="#FFF" fill-opacity=".9" xlink:href="#prefix__i"></use>
                                            </g>
                                            <rect width="35" height="35" x="40" y="57"
                                                fill="#D8D8D8" fill-opacity=".35" rx="4"></rect>
                                            <g transform="translate(0 14)">
                                                ...
                                                <rect fill="url(#prefix__j)" style="mix-blend-mode:overlay"
                                                    width="60" height="60" rx="4"></rect>
                                            </g>
                                            ...
                                            <g>
                                                <g fill-rule="nonzero" transform="translate(199)">
                                                    <use fill="#000" filter="url(#prefix_m)" xlink:href="#prefix_n">
                                                    </use>
                    ...
                    <div class="card card-body">
                        ...
                        <div style="padding: 0;margin: 0;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="290" height="180" viewBox="0 0 290 180">
                                <defs>
                                    <linearGradient id="prefix__e" x1="50%" x2="50%" y1="0%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#FFF" stop-opacity=".75"></stop>
                                        <stop offset="100%" stop-color="#2C2C2C" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__f" x1="0%" x2="122.816%" y1="50%"
                                        y2="50%">
                                        <stop offset="0%" stop-color="#FFF"></stop>
                                        <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__i" x1="50%" x2="50%" y1="0%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#FFF" stop-opacity=".75"></stop>
                                        <stop offset="48.301%" stop-color="#999" stop-opacity=".388"></stop>
                                        <stop offset="100%" stop-color="#2C2C2C" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__j" x1="0%" x2="122.816%" y1="50%"
                                        y2="50%">
                                        <stop offset="0%" stop-color="#FFF"></stop>
                                        <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
                                    </linearGradient>
                                    ...
                                    <rect id="prefix__a" width="290" height="182" x="0" y="0"
                                        rx="10"></rect>
                                    <rect id="prefix__d" width="307" height="283" x="14" y="0"
                                        rx="7"></rect>
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <g>
                                            <g transform="translate(64 26)">
                                                <use fill="#000" filter="url(#prefix_c)" xlink:href="#prefix_d"></use>
                                                <rect width="307.5" height="283.5" x="13.75" y="-.25"
                                                    fill="#FFF" fill-opacity=".6" stroke="#979797"
                                                    stroke-opacity=".05" stroke-width=".5" rx="7"></rect>
                                            </g>
                                            <g>
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <use fill="#000" filter="url(#prefix_k)" xlink:href="#prefix_l"></use>
                    ...
                    <div class="card card-body">
                        ...
                        <div style="padding: 0;margin: 0;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="290" height="180" viewBox="0 0 290 180">
                                <defs>
                                    <rect id="prefix__a" width="290" height="179" x="0" y="0"
                                        rx="10"></rect>
                                    <rect id="prefix__c" width="230" height="240" x="12" y="29"
                                        rx="5"></rect>
                                    <rect id="prefix__g" width="35" height="35" x="0" y="0"
                                        rx="4"></rect>
                                    <rect id="prefix__i" width="230" height="240" x="0" y="0"
                                        rx="5"></rect>
                                    <rect id="prefix__l" width="25.575" height="18" x=".165" y=".165"
                                        rx="2"></rect>
                                    <rect id="prefix__o" width="25" height="15" x="0" y="0"
                                        rx="2"></rect>
                                    <rect id="prefix__r" width="90" height="60" x="0" y="0"
                                        rx="3"></rect>
                                    <rect id="prefix__t" width="90" height="60" x="0" y="0"
                                        rx="3"></rect>
                                    <linearGradient id="prefix__e" x1="0%" x2="122.816%" y1="50%"
                                        y2="50%">
                                        <stop offset="0%" stop-color="#FFF"></stop>
                                        <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__f" x1="120.454%" x2="35.454%" y1="50%"
                                        y2="50%">
                                        <stop offset="0%" stop-color="#FFF" stop-opacity="0"></stop>
                                        <stop offset="100%" stop-color="#FFF"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__h" x1="50%" x2="50%" y1="0%"
                                        y2="100%">
                                        <stop offset="0%" stop-color="#FFF" stop-opacity=".75"></stop>
                                        <stop offset="100%" stop-color="#2C2C2C" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__p" x1="50%" x2="50%" y1="0%"
                                        y2="138.853%">
                                        <stop offset="0%" stop-color="#4D4D4D"></stop>
                                        <stop offset="100%" stop-color="#848484"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__q" x1="0%" x2="122.816%" y1="50%"
                                        y2="50%">
                                        <stop offset="0%" stop-color="#FFF"></stop>
                                        <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
                                    </linearGradient>
                                    <linearGradient id="prefix__v" x1="100%" x2="36.8%" y1="50%"
                                        y2="50%">
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <g transform="translate(8 28)">
                                            ...
                                            <g transform="translate(32 49)">
                                                ...
                                                <rect fill="url(#prefix__h)" style="mix-blend-mode:overlay"
                                                    width="35" height="35" rx="4"></rect>
                                                <g fill="#000">
                                                    <path
                                    ...
                                    <g mask="url(#prefix__b)">
                                        <g>
                                            <g transform="translate(99 16)">
                                                ...
                                                <use fill="#000" filter="url(#prefix_j)" xlink:href="#prefix_i"></use>
                                                ...
                                                <g mask="url(#prefix__k)">
                                                    <g transform="translate(25 31)">
                                                        ...
                                                        <g transform="translate(9 11)">
                                                            <use fill="#000" filter="url(#prefix_n)"
                                                                xlink:href="#prefix_o"></use>
                                                            <use fill="url(#prefix_p)" xlink:href="#prefix_o"></use>
                                                            <path fill="#FFF" fill-rule="nonzero"
                                            ...
                                            <g transform="translate(99 16) translate(22 119)">
                                                ...
                                                <rect width="89.5" height="59.5" x=".25" y=".25"
                                                    stroke="#777" stroke-opacity=".5" stroke-width=".5" rx="3">
                                                </rect>
            ...
            <div class="row" style="margin-top: 100px;">
                <div class="col-md-6">
                    ...
                    <div style="border-left: 1px solid black;margin-top: 40px;padding: 15px;">
                        <h1 id="demo" style="color: green;font-size: 70px;font-weight: 800;">84,692,235</h1>
                ...
                <div class="col-md-6">
                    ...
                    <div class="tradingview-widget-container active6"
                        style="margin-bottom: 3px; width: 100%; height: 249px;" id="widget5">
                        <iframe scrolling="no" allowtransparency="true" frameborder="0"
                    ...
                    <!-- TradingView Widget BEGIN -->
                    <div class="tradingview-widget-container active6"
                        style="margin-bottom: 3px; width: 100%; height: 273px;" id="widget6">
                        <iframe scrolling="no" allowtransparency="true" frameborder="0"
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-12 align-items-center mb-10 mb-md-13">
                <div class="col-lg-6 position-relative">
                    ...
                    <div class="row gx-md-5 gy-5 align-items-center">
                        <div class="col-md-6">
                            <div class="row gx-md-5 gy-5">
                                <div class="col-md-10 offset-md-2">
                                    <figure class="rounded"><img src="frontend/assets/img/photos/ab1.jpg" alt="">
                                    </figure>
                                </div>
                                <!--/column -->
                                <div class="col-md-12">
                                    <figure class="rounded"><img src="frontend/assets/img/photos/ab2.jpg" alt="">
                                    </figure>
                                </div>
                                <!--/column -->
                            </div>
                        ...
                        <!--/column -->
                        <div class="col-md-6">
                            <figure class="rounded"><img src="frontend/assets/img/photos/ab3.jpg" alt="">
                            </figure>
                        </div>
                        <!--/column -->
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-7">Finding the best investment firm to work with can make or break your financial
                        security. Whether you're investing a
                        little or a lot, your money is just as important to you, and it's critical to find a financial
                        investment professional
                        you can rely on to steer you toward wise investment buys.</p>
                    <div class="row gy-3">
                        <div class="col-xl-6">
                            <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                <li><span><i class="uil uil-check"></i></span><span>Seasoned financial experts and
                                        brokers.</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>We are constantly
                                        hungry to learn new things and to impart the finest knowledge we can to our
                                        consumers.</span></li>
                            </ul>
                        </div>
                        <!--/column -->
                        <div class="col-xl-6">
                            <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                <li><span><i class="uil uil-check"></i></span><span>Better investment decisions, informed
                                        by rigorous, proprietary macro-economic research and market analysis.</span></li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">We assure you that it is our desire and intentions to keep the doors of
                                consultation always and fully open.</p>
                        </div>
                    </div>
                </div>
                <!--/column -->
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Our team of professionals are committed to guiding you in choosing plans
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">We all want wealth, but how do we achieve it? It starts with a successful
                                Investment into an Opportunity which no one
                                else seems to see.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                ...
                                <p class="mb-2">We all want wealth, but how do we achieve it? It starts with a
                                    successful Investment into an Opportunity which no one
                                    else seems to see.</p>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                ...
                                <p class="mb-2">Wages are only medicine to poverty as you need other source of incomes
                                    in order to meet up with your Taxes and that is
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                ...
                                <p class="mb-2">Don't simply retire from something; have something to retire to. We are
                                    here to help you with that.</p>
                    ...
                    <div class="card one">
                        <div class="top">
                            ...
                            <div class="price-sec">
                                ...
                                <span class="decimal">min</span>
                            </div>
                        </div>
                        <div class="info">Limited features you will get on this package or plan</div>
                        <div class="details">
                            <div class="one">
                                <span>Duration of {{ $price->noofrepeat }} days</span>
                                <i class="fas fa-check"></i>
                            </div>
                            <div class="one">
                                <span> Max Deposit ${{ $price->maximum }} </span>
                                <i class="fas fa-check"></i>
                            </div>
                            <div class="one">
                                <span>Total Profit {{ $price->percentage * $price->noofrepeat }}%</span>
                                <i class="fas fa-check"></i>
                            </div>
                            <div class="one">
                                <span>Referal bonus {{ $price->refpercent }}%</span>
                                <i class="fas fa-check"></i>
                            </div>
                            <div class="one">
                                <span>Withdrawal weekly</span>
                                <i class="fas fa-check"></i>
                            </div>
        ...
        <div class="container py-8 py-md-16">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="">At highclove Finance, our customers are put first at all times. Your own Client
                        Relationship Officer is there for you
                        every step of the way whether you're delving into a specific issue, taking in the big picture, or
                        balancing financial
                        opportunities and risks. Our objective is to fully understand your requirements and work with you to
                        develop long-term
                        perspectives so that we can give you the best advice and react swiftly and efficiently, even if
                        circumstances alter
                        unforeseenly.</p>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <blockquote class="icon icon-top fs-lg text-center">
                                                    <p>“I am completely new to investing, so this is like learning a new
                                                        language to
                                            ...
                                            <div class="swiper-slide">
                                                <blockquote class="icon icon-top fs-lg text-center">
                                                    <p>"I’ve been a client at highclove investment for many years, I
                                                        appreciate the
                                                        courtesy from the staff, not only do they have an outstanding work
                                                        ethic and their moral
                                                        standards are of the highest caliber, I would recommend highclove to
                                                        anyone without
                                                        Hesitation."</p>
                                                    <div class="blockquote-details justify-content-center text-center">
                                                        <div class="info ps-0">
                                            ...
                                            <div class="swiper-slide">
                                                <blockquote class="icon icon-top fs-lg text-center">
                                                    <p>"I travel a lot because for my work and usually don’t have much time
                                                        to monitor
                                                        my account, I get emails of the progress, money is sent to me
                                                        wherever I am and it’s just
