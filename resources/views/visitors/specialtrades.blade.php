...
<main class="special-trades-contents whatweinvestin-page">
	...
	<section>
		...
		<div class="paragraph">
			...
			<p>
				NFTs have been taking the internet by storm and have simply doubled their total volume in USD in the month of February alone. So what are these digital assets selling for fortunes, from niche marketplaces to world-famous auction house Christie’s &quest;


			</p>
		</div>
		<div class="paragraph nft-image-gallery flex">
			<div class="img-container">
				<img src="{{asset("images/nft1.jpg")}}" alt="Nft image">
			</div>
			<div class="img-container">
				<img src="{{asset("images/nft2.jpg")}}" alt="Nft image">
			</div>
			<div class="img-container">
				<img src="{{asset("images/nft3.jpg")}}" alt="Nft image">
			</div>
		</div>
		<div class="paragraph">
			<p>
		...
		<div class="paragraph">
			...
			<div class="img-container">
				<img src="{{asset("images/defi.jpg")}}" alt="Defi image">
			</div>
			<p>
...
With smart contracts at the core, dozens of DeFi applications are operating on Ethereum, some of which are explored below. Ethereum 2.0, a coming upgrade to Ethereum’s underlying network, could give these apps a boost by chipping away at Ethereum’s scalability issues.
		...
		<div class="paragraph">
			<p>The most popular types of DeFi applications include:</p>
			<p>
				<strong>Decentralized exchanges (DEXs):</strong> Online exchanges help users exchange currencies for other currencies, whether U.S. dollars for bitcoin or ether for DAI. DEXs are a hottype of exchange, which connects users directly so they can trade cryptocurrencies with one another without trusting an intermediary with their money.
				<br>
				<strong>Stablecoins:</strong> A cryptocurrency that's tied to an asset outside of cryptocurrency (the dollar or euro, for example) to stabilize the price.
				<br>
				...
				<br>
				<strong>Prediction markets:</strong> Markets for betting on the outcome of future events, such as elections. The goal of DeFi versions of prediction markets is to offer the same functionality but without intermediaries. In addition to these apps, new DeFi concepts have sprung up around them.
				<br>
				<strong>Yield farming:</strong> For knowledgeable traders who are willing to take on risk, there's yield farming, where users scan through various DeFi tokens in search of opportunities for larger returns.
				<br>
				<strong>Liquidity mining:</strong> When DeFi applications entice users to their platform by giving them free tokens. This has been the buzziest form of yield farming yet.
				<br>
				<strong>Composability:</strong> DeFi apps are open source, meaning the code behind them is public for anyone to view. As such, these apps can be used to "compose" new apps with the code as building blocks.
				<br>
				<strong>Money legos:</strong> Putting the concept "composability" another way, DeFi apps are like Legos, the toy blocks children click together to construct buildings, vehicles and so on. DeFi apps can be similarly snapped together like "money legos" to build new financial products.
			</p>
		</div>
		<div class="paragraph">
			<h2>Initial Exchange Offering</h2>
			<p>
		...
		<div class="paragraph">
			<h3>What are the Benefits of an IEO?</h3>
			<p>
