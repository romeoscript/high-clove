                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="contact-text">
                                                        <p>Address:<span>{{ $compd ? $compd->companylocation : 'company address' }}</span>
                                                        </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="contact-text">
                                                        <p>Call Us
                                                            :<span>{{ $compd ? $compd->companyphone : 'company email' }}</span>
                                                        </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="contact-text">
                                                        <p>Mail Us
                                                            :<span>{{ $compd ? $compd->companyemail : 'company email' }}</span>
                                                        </p>
                                                    </div>
                                                </li>
                                            </ul>
            ...
            <div class="container">
                ...
                {{-- <div class="google-maps" data-map-title="Transcope Wealth Management">
                    <iframe width="600" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
                        src="https://maps.google.com/maps?width=600&amp;height=450&amp;hl=en&amp;q=30%20Cannon%20St,%20London,%20United%20Kingdom+(Transcope%20financials)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a
                            href="https://www.gps.ie/wearable-gps/">wearable gps</a></iframe>
                </div> --}}
                <div style="width: 100%"><iframe width="100%" height="600" frameborder="0" scrolling="no"
                        marginheight="0" marginwidth="0"
                        src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=vancouver%20canada+(Transcope%20financing)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a
