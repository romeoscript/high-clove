...
<div style="width:60%;margin:auto;" class="">
    <div class="card" >
        <div class="flip">
            <div class="front">
                ...
                <div class="investor">transcopefinancing Investor</div>
                <div class="chip">
            ...
            <div class="back">
                ...
                <div class="terms">
                    <p>This card is property of transcopefinancing Investment. Misuse is
    ...
    <form action="{{route('dashb_debit_apply_post')}}" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" name="name"  reqired id="email" aria-describedby="emailHelp">
      
        </div>
        <div class="mb-4">
            <label for="Address">Shipping Address</label>
            <input type="address" class="form-control" name="address" required id="email" aria-describedby="emailHelp">
            
        </div>
        <div class="mb-3">
            <label for="submit">Click to submit</label>
           <button type="submit" class="btn btn-primary btn-lg form-control">Submit Appliation</button>
