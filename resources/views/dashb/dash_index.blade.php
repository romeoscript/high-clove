                            ...
                            <div class="row">
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="mailto:?subject=Invitation&body=Hello+dear%2C+I+am+happy+to+invite+you+to+join+highclove+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://wa.me/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+highclove+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
                                ...
                                <div class="col-6 col-md-12">
                                    <form class="forms-sample mt-2" action='ref.html' method="post">
                                        <a href="https://t.me/share/?text=Hello+dear%2C+I+am+happy+to+invite+you+to+join+highclove+%2C+a+reliable+investment+website+that+helps+you+to+trade+and+return+your+profit.+Use+my+link+to+register+{{route('register')}}%3Frefid%3D{{Auth::user()->id}}"
